...
object Graph {
  ...
  def fromEdgeTuples[VD: ClassTag](
      ...
      edgeStorageLevel: StorageLevel = StorageLevel.DISK_ONLY,
      vertexStorageLevel: StorageLevel = StorageLevel.DISK_ONLY): Graph[VD, Int] =
  {
  ...
  def fromEdges[VD: ClassTag, ED: ClassTag](
      ...
      defaultValue: VD,
      edgeStorageLevel: StorageLevel = StorageLevel.DISK_ONLY,
      vertexStorageLevel: StorageLevel = StorageLevel.DISK_ONLY): Graph[VD, ED] = {
