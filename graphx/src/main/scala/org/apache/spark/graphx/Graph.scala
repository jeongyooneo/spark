...
abstract class Graph[VD: ClassTag, ED: ClassTag] protected () extends Serializable {
   ...
   */
  def persist(newLevel: StorageLevel = StorageLevel.NONE): Graph[VD, ED]

  /**
   * Caches the vertices and edges associated with this graph at the previously-specified target
   * storage levels, which default to `NONE`. This is used to pin a graph in memory enabling
...
object Graph {
  ...
  def fromEdgeTuples[VD: ClassTag](
      ...
      edgeStorageLevel: StorageLevel = StorageLevel.NONE,
      vertexStorageLevel: StorageLevel = StorageLevel.NONE): Graph[VD, Int] =
  {
  ...
  def fromEdges[VD: ClassTag, ED: ClassTag](
      ...
      defaultValue: VD,
      edgeStorageLevel: StorageLevel = StorageLevel.NONE,
      vertexStorageLevel: StorageLevel = StorageLevel.NONE): Graph[VD, ED] = {
