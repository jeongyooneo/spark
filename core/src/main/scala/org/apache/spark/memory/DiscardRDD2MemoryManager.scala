 ...
 */
private[spark] class DiscardRDD2MemoryManager private[memory] (
    conf: SparkConf,
...
object DiscardRDD2MemoryManager {
  ...
  def apply(conf: SparkConf, numCores: Int): DiscardRDD2MemoryManager = {
    val maxMemory = getMaxMemory(conf)
    new DiscardRDD2MemoryManager(
      conf,
